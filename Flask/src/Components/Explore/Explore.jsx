...
const Explore = () => {
  ...
  <div>
    ...
    <div className="cards">
        ...
        <div className="card"><Link to={'http://localhost:3000/analytics'}><img id='analytics' src="analytics.png" alt="" height={"100px"}/><div className='card-content'><h2>ANALYTICS</h2><p>Gain valuable insights and make data-driven decisions with our powerful analytics tool. Unlock the potential of your data today!</p><Button name='Analytics'/></div></Link></div>
